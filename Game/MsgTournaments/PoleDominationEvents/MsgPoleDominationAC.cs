...
namespace COServer.Game.MsgTournaments
{
    ...
    public class MsgPoleDomination
    {
        ...
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Server.ServerMaps[1020].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 830));
        }
        ...
        public void CheckUp()
        {
            ...
            {
                if (DateTime.Now > MsgSchedules.PoleDomination.StampShuffleScore)
                {
                    MsgSchedules.PoleDomination.ShuffleGuildScores();
                }
