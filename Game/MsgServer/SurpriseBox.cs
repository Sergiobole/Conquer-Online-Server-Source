...
namespace COServer.Game.MsgServer
{
    public class SurpriseBox
    {
        ...
        {
            700003, 700013, 700023, 700033, 700043, 700053, 700063, 700073, 723744, 723725, 730004, 723701, 721080
        };
        ...
        public static void GetReward(GameClient client, ServerSockets.Packet stream)
        {
            ...
            if (chance <= 1) 
            {
                ...
                Console.WriteLine("teste2socket");
            ...
            else if (chance <= 3) 
            {
                ...
                Console.WriteLine("teste1socket");
